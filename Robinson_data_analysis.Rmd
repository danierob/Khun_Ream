...
ggplot(LAIxbiomass_early_late, aes(x = mean_LAI, y = grass_mass, color = season)) +
  ...
  labs(title = "Scatterplot with Regression Lines",
       x = "mean_LAI", y = "Grass Load (g/", color = "season") +
  ylim(0, 230) +
  theme_minimal()
```
In this plot, the early season regression line is identical to 1.2.1a, but the late season regression has shifted to the left, exaggerating the difference in intercept between early and late season. The difference in the intercept between 1.2.1a and 1.2.1b emphasizes the role
