...
In Q1 we looked at how fuel is distributed along the canopy gradient, in that question we were essentially looking at fuel availability in terms of the physical presence. If fuel is present, its physical availability tends to change slowly unless it is removed by some outside influence, say a cow or a fire. If this influence functions to *maintain* the existing state of ecosystem conditions, such as a fire in a perennial grassland, this is **positive feedback**, positive feedback reinforces the status quo. Alternatively, if an influence functions to *disrupt* the existing state of an ecosystem this would be a **negative feedback**. With the exception of mass leaf shedding events, there is little sporadic change when dealing with the physical presence of fuel or fuel distributio
