...
**Simple Linear Model:**
Assumptions are tested in markdown, but not included in knitted document.
...
**Mixed Effects Model:**
Assumptions tested in markdown code, not included here. Mixed effects assumptions tests look better, as does summary statistics.
