...
In Q1 we looked at how fuel is distributed along the canopy gradient, in that question we were essentially looking at fuel availability in terms of the physical presence of flammable vegetation. At the coasest scale, fuel presence is determined by climate (ref...). In our system, the climate is sufficient to support continuous vegetation and the presence of fuel is largely moderated through feedbacks (Pausas, ref..) ( see outline). When fuel is present, its physical availability tends to change due to relatvely slow process (growth and decay), unless it is removed by some outside influence (a grazing cow or a fire). In the absence of cow or fire, surface fuels will accumulate gradually with leaf fall (dry season) or new growth (wet season) or decrease gradually through dessication.
