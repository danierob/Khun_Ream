...
#merging LAI_1 and biomass_1 into LAIxbiomass_2
LAIxbiomass_2 <- right_join(LAI_1, biomass_2, by = c("plot_id", "quad_id"))
...
**1.2.1b)** Now, we will write a model that temporally pairs biomass and LAI obs, so early season grass will be paired with early season LAI obs and late season grass will be paired with late season LAI obs. Doing this to see if there are obvious differences between method, a or b. Which may shed some insight into the roll of seasonally changing canopy cover
