...
Fitting a line for grass biomass across the canopy gradient will require a polynomial regression.
...
In this analysis, we consider the relationship between LAI and fine fuel bulk density at peak biomass that is, only considering biomass ob. 1 (as in 1.1.1), to evaluate the maximum extent of fine fuel load discrepancy.
