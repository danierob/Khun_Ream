...
p2 <- ggplot() +
  geom_point(data = behave, aes(x = LAI, y = ROS, color = season), alpha = .7) +
  geom_line(data = pred_data_late, aes(x = LAI, y = fit), size = 1, color = "cyan3")+
  geom_line(data = pred_data_early, aes(x = LAI, y = fit), color = "salmon", size = 1)+
  geom_vline(xintercept = fixed_effects_late[4], linetype = "dashed", color = "cyan3")+
  geom_vline(xintercept = fixed_effects_early[4], linetype = "dashed", color = "salmon") +
  ...
  labs(x = "Canopy Cover (LAI)",  y = expression("Rate of Spread (m/min)")) +
  theme_bw()+
  theme(
    axis.title = element_text(size = 12),   
    legend.title = element_text(size = 10),     
...
p1 <- ggplot() +
  geom_point(data = behave, aes(x = LAI, y = flame_length, color = season), alpha = .7) +
  geom_line(data = pred_data_late, aes(x = LAI, y = fit), size = 1, color = "cyan3")+
  geom_line(data = pred_data_early, aes(x = LAI, y = fit), color = "salmon", size = 1)+
  geom_vline(xintercept = fixed_effects_late[4], linetype = "dashed", color = "cyan3")+
  geom_vline(xintercept = fixed_effects_early[4], linetype = "dashed", color = "salmon") +
...
ms_intl <- segmented.lme(m_intl, ~LAI, psi = 2.5, random = list(plot_id=pdDiag(~1+LAI+U+G0)))
...
p3 <- ggplot() +
  geom_point(data = behave, aes(x = LAI, y = intensity, color = season), alpha = .7) +
  geom_line(data = pred_data_late, aes(x = LAI, y = fit), size = 1, color = "cyan3")+
  geom_line(data = pred_data_early, aes(x = LAI, y = fit), color = "salmon", size = 1)+
  geom_vline(xintercept = fixed_effects_late[4], linetype = "dashed", color = "cyan3")+
  geom_vline(xintercept = fixed_effects_early[4], linetype = "dashed", color = "salmon") +
  ...
  labs(x = "Canopy Cover (LAI)",  y = expression("Fireline Intensity (kW/m)")) +
  theme_bw()+
  theme(
    axis.title = element_text(size = 12),   
    legend.title = element_text(size = 10),     
...
p4 <- ggplot(data = pig_dat, aes(x = LAI, y = (yvar^2), color = season)) +
  geom_line(size = .8) +
  labs(x="Canopy Cover (LAI)", y = "Probability of Ignition (%)", color = "Time of Dry Season", fill = "Season")+
  theme_bw()

#add points from the original data
p4 <- p4 + geom_point(data = behave, aes(x = LAI, y = PIG, color = season), alpha = .7) +
  theme(
    axis.title = element_text(size = 12),   
    legend.title = element_text(size = 10),     
    legend.text = element_text(size = 8),        
