...
p2 <- SA_evg %>% 
  ggplot(aes(x = variable, y = ROS)) +
  geom_col(fill = "darkslategray")+
  labs(x = "Fuel Factor", y = "Rate of Spread Increase (m/min)", title = "Forest")+
  theme(text=element_text(size= 14), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
   theme_bw()
...
p4 <- SA_evg %>% 
  ggplot(aes(x = variable, y = intensity)) +
  geom_col(fill = "darkslategray")+
  labs(x = "Fuel Factor", y = "Fire Intensity Increase (kW/m)", title = "Forest")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
  theme_bw()
...
p6 <- SA_evg %>% 
  ggplot(aes(x = variable, y = flame_length)) +
  geom_col(fill = "darkslategray")+
  labs(x = "Fuel Factor", y = "Flame Length Increase (m)", title = "Forest")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
  theme_bw()
...
combined_plot <- plot_grid(p2, p4, p6, ncol = 1, align = "v", rel_heights = c(1, 1, 1))
