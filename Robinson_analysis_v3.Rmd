...
ggplot(aes(x = variable, y = ROS)) +
  ...
  labs(x = "Environmental Factor", y = "Rate of Spread Increase (m/min)", title = "Early Season")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
  ylim(-.3,2)+
  theme_minimal()
...
p2 <- SA_late %>% 
  ggplot(aes(x = variable, y = ROS)) +
  geom_col(fill = "darkred")+
  labs(x = "Environmental Factor", y = "Rate of Spread Increase (m/min)", title = "Late Season")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
  ylim(-.3,2)+
   theme_minimal()
...
p1 <- p1 + scale_x_discrete(labels = c("fuel class", "fuel density", "fuel load", "FMC", "wind speed")) +
...
ggplot(aes(x = variable, y = ROS)) +
  geom_col(fill = "darkred")+
  labs(x = "Environmental Factor", y = "Rate of Spread Increase (m/min)", title = "Savanna")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
  theme_minimal()
...
p2 <- SA_evg %>% 
  ggplot(aes(x = variable, y = ROS)) +
  geom_col(fill = "darkred")+
  labs(x = "Environmental Factor", y = "Rate of Spread Increase (m/min)", title = "Forest")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
   theme_minimal()
