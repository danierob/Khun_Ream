...
#There was an issue with too many observations so we'll compare with rh by day and it is the same significance wise
m <- lmer(mean_rh ~ season*plot_type + (1|plot_id), data = kestrel_rh_month)
emm <- emmeans(m, ~season*plot_type)
tukey_results <- pairs(emm, adjust = "tukey")
summary(tukey_results)
summary(emm)
...
#add points from the original data
p1 <- p1+ geom_point(data = fmc_seasons, aes(x = LAI, y = litter, shape = season, color = season, fill = season), alpha = .7) +
  scale_shape_manual(values = c("early" = 16, "late" = 17)) + 
  scale_color_manual(values = c("early" = "darkslategray", "late" = "darkorange3")) + 
  guides(shape = guide_legend(override.aes = list(color = c("darkslategray", "darkorange3"))))+
  scale_linetype_manual(values = c("solid", "solid"))+ 
...
#add points from the original data
p2 <- p2 + geom_point(data = fmc_seasons, aes(x = LAI, y = grass, shape = season, color = season, fill = season), alpha = .7) +
  scale_shape_manual(values = c("early" = 16, "late" = 17)) + 
  scale_color_manual(values = c("early" = "darkslategray", "late" = "darkorange3")) + 
  guides(shape = guide_legend(override.aes = list(color = c("darkslategray", "darkorange3"))))+
  scale_linetype_manual(values = c("solid", "solid"))+ 
...
#add points from the original data
p3 <- p3 + geom_point(data = fmc_seasons, aes(x = LAI, y = woody_leaf, shape = season, color = season, fill = season), alpha = .7) +
  scale_shape_manual(values = c("early" = 16, "late" = 17)) + 
  scale_color_manual(values = c("early" = "darkslategray", "late" = "darkorange3")) + 
  guides(shape = guide_legend(override.aes = list(color = c("darkslategray", "darkorange3"))))+
  scale_linetype_manual(values = c("dashed", "dashed"))+ 
...
#add points from the original data
p4 <- p4 + geom_point(data = behave, aes(x = LAI, y = PIG, shape = season, color = season), alpha = .7, size = .8) +
  scale_shape_manual(values = c("early" = 16, "late" = 17)) + 
  scale_color_manual(values = c("early" = "darkslategray", "late" = "darkorange3")) +
  guides(shape = guide_legend(override.aes = list(color = c("darkorange3", "darkslategray"))))+
  theme(
...
ggplot(aes(x = variable, y = intensity)) +
  geom_col(fill = "darkred")+
  labs(x = "Environmental Factor", y = "Fire Intensity Increase (kW/m)", title = "Early Season")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
  ylim(-50,400)+
  theme_minimal()
...
p4 <- SA_late %>% 
  ggplot(aes(x = variable, y = intensity)) +
  geom_col(fill = "darkred")+
  labs(x = "Environmental Factor", y = "Fire Intensity Increase (kW/m)", title = "Late Season")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
   ylim(-50,400)+
  theme_minimal()

p3 <- p3 + scale_x_discrete(labels = c("fuel class", "fuel density", "fuel load", "FMC", "wind speed")) +
    theme(axis.title = element_text(size = 10),   
    legend.title = element_text(size = 10),     
    legend.text = element_text(size = 8),        
...
p4 <-p4 + scale_x_discrete(labels = c("fuel class", "fuel density", "fuel load", "FMC", "wind speed")) +
    theme(axis.title = element_text(size = 10),   
    legend.title = element_text(size = 10),     
    legend.text = element_text(size = 8),        
    plot.title = element_text(size = 14),
...
ggplot(aes(x = variable, y = flame_length)) +
  geom_col(fill = "darkred")+
  labs(x = "Environmental Factor", y = "Flame Length Increase (m)", title = "Early Season")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
  ylim(-.2,1)+
  theme_minimal()
...
p6 <- SA_late %>% 
  ggplot(aes(x = variable, y = flame_length)) +
  geom_col(fill = "darkred")+
  labs(x = "Environmental Factor", y = "Flame Length Increase (m)", title = "Late Season")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
  ylim(-.2,1)+
  theme_minimal()

p5 <- p5 + scale_x_discrete(labels = c("fuel class", "fuel density", "fuel load", "FMC", "wind speed")) +
    theme(axis.title = element_text(size = 10),   
    legend.title = element_text(size = 10),     
    legend.text = element_text(size = 8),        
    plot.title = element_text(size = 14),
...
p6 <- p6+ scale_x_discrete(labels = c("fuel class", "fuel density", "fuel load", "FMC", "wind speed")) +
    theme(axis.title = element_text(size = 10),   
    legend.title = element_text(size = 10),     
    legend.text = element_text(size = 8),        
    plot.title = element_text(size = 14),
...
combined_plot <- plot_grid(p1, p2, p3, p4, p5, p6, ncol = 2, align = "v", rel_heights = c(1, 1, 1, 1, 1, 1))
...
p2 <- p2+ scale_x_discrete(labels = c("fuel class", "fuel density", "fuel load", "FMC", "wind speed")) +
    theme(axis.title = element_text(size = 10),   
    legend.title = element_text(size = 10),     
    legend.text = element_text(size = 8),        
    plot.title = element_text(size = 12),
...
ggplot(aes(x = variable, y = intensity)) +
  geom_col(fill = "darkred")+
  labs(x = "Environmental Factor", y = "Fire Intensity Increase (kW/m)", title = "Savanna")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
  theme_minimal()
...
p4 <- SA_evg %>% 
  ggplot(aes(x = variable, y = intensity)) +
  geom_col(fill = "darkred")+
  labs(x = "Environmental Factor", y = "Fire Intensity Increase (kW/m)", title = "Forest")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
  theme_minimal()
...
ggplot(aes(x = variable, y = flame_length)) +
  geom_col(fill = "darkred")+
  labs(x = "Environmental Factor", y = "Flame Length Increase (m)", title = "Savanna")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
  theme_minimal()
...
p6 <- SA_evg %>% 
  ggplot(aes(x = variable, y = flame_length)) +
  geom_col(fill = "darkred")+
  labs(x = "Environmental Factor", y = "Flame Length Increase (m)", title = "Forest")+
  theme(text=element_text(size= 16), legend.position="none", 
        plot.title = element_text(hjust = 0.5))+
  theme_minimal()
...
combined_plot <- plot_grid(p1, p3, p5, ncol = 1, align = "v", rel_heights = c(1, 1, 1))
